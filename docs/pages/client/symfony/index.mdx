...
```bash
composer require traceway/opentelemetry-symfony open-telemetry/sdk open-telemetry/exporter-otlp php-http/guzzle7-adapter
```
...
- [OpenTelemetry docs](/client/otel) — how OTel traces and metrics map to Traceway
