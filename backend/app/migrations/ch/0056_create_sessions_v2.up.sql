...
(
    ...
    INDEX idx_session_attr_keys mapKeys(attributes) TYPE bloom_filter(0.01) GRANULARITY 1,
    INDEX idx_session_attr_values mapValues(attributes) TYPE bloom_filter(0.01) GRANULARITY 1
)
