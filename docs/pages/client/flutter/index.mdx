...
Or load it from your bundled JS. See the full [JS SDK documentation](/client/js-sdk?sdk=js-generic) for all options including session recording, error filtering, and distributed tracing.
